...
export default function Navbar() {
  ...
  const { getPhoneDisplay } = useBusinessInfo();
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <a
                ...
                aria-label={`Llamar ahora al número de emergencia ${phoneDisplay}`}
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
      ...
      <a
        ...
        aria-label={`Emergencia veterinaria 24/7 - Llamar al ${phoneDisplay}`}
      >
        <svg
          className="w-7 h-7"
          fill="currentColor"
